...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-12-2013 a las 02:05:12
...
(724, '', 'auto_increment', 'id', 'PRI', 'NO', 'int(11)', 'Text Input', '{"etiqueta":"Id","requerido":"0","oculto":"1","editable":"1"}', 66),
(725, '', '', 'nombre', '', 'YES', 'char(255)', 'Text Input', '{"etiqueta":"Nombre","requerido":"0","editable":"1","oculto":"0" }', 66),
(726, '', '', 'bandera', '', 'YES', 'char(255)', 'Text Input', '{"etiqueta":"Bandera","requerido":"0","editable":"1","oculto":"0" }', 66),
(727, '', 'auto_increment', 'id', 'PRI', 'NO', 'int(11)', 'Text Input', '{"etiqueta":"Id","requerido":"0","oculto":"1","editable":"1"}', 67),
(728, '', '', 'nombre', '', 'YES', 'char(255)', 'Text Input', '{"etiqueta":"Nombre","requerido":"0","editable":"1","oculto":"0" }', 67),
(729, '', '', 'fk_pais', '', 'YES', 'int(11)', 'Combo Box', '{"etiqueta":"Pais","requerido":"0","oculto":"0","editable":"1","target":"66","campo_a_mostrar":"nombre"}', 67),
(730, '', 'auto_increment', 'id', 'PRI', 'NO', 'int(11)', 'Text Input', '{"etiqueta":"Id","requerido":"0","oculto":"1","editable":"1"}', 68),
(731, '', '', 'nombre', '', 'YES', 'char(255)', 'Text Input', '{"etiqueta":"Nombre","requerido":"0","editable":"1","oculto":"0" }', 68),
(732, '', '', 'clave_sepomex', '', 'YES', 'char(255)', 'Text Input', '{"etiqueta":"Clave_sepomex","requerido":"0","oculto":"1","editable":"1"}', 68),
(733, '', '', 'fk_estado', '', 'YES', 'int(11)', 'Combo Box', '{"etiqueta":"Estado","requerido":"0","oculto":"0","editable":"1","target":"67","campo_a_mostrar":"nombre"}', 68),
...
INSERT INTO `makinas_corte` (`id`, `fk_maquina`, `fk_cliente`, `fk_pdv`, `fk_tecnico`, `cont_entrada`, `cont_salida`, `saldo_contadores`, `dato_de_la_placa`, `monto`, `fecha`, `fk_serie`, `folio`) VALUES
(27, 1, 1, 1, 1, '0.000000', '0.000000', '0.000000', '', '0.000000', '2013-12-18 17:57:00', 1, 5);
...
(50, 5, 'Catalogos', 'catalogos', 'Catalogo', 'system_catalogos', 'id', 'http://png.findicons.com/files/icons/577/refresh_cl/48/windows_view_icon.png', 'Nuevo Catalogo', '''Catalogo: '' + getValorCampo(''nombre'')', '''Buscar Catalogos''', 'Catalogo Creado', 'Catalogo Actualizado', 'Eliminar Catalogo', 'Catalogo Eliminado', 'Ha hecho cambios en el catalogo,ï¿½Guardar antes de salir?', 'nombre'),
...
(66, 6, 'Pais', 'paises', 'pais', 'system_ubicacion_paises', 'id', '', 'Nuevo Pais', '''Pais: '' + getValorCampo(''nombre'')', 'Paises', 'Pais Creado', 'Pais Actualizado', '', '', '', ''),
(67, 6, 'Estados', 'estados', 'estado', 'system_ubicacion_estados', 'id', '', 'Nuevo Estado', '''Estado: '' + getValorCampo(''nombre'')', 'Estados', 'Estado Creado', 'Estado Actualizado', '', '', '', ''),
(68, 6, 'Municipio', 'municipios', 'municipio', 'system_ubicacion_municipios', 'id', '', 'Nuevo Municipio', '''Municipio: '' + getValorCampo(''nombre'')', 'Municipios', 'Municipio Creado', 'Municipio Actualizado', '', '', '', ''),
