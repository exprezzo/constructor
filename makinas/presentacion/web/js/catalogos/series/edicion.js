var EdicionSeries = function(){
	...
	this.setDSFk_owner = function(){		
		...
		var proxy = new wijhttpproxy({
			url: kore.url_base+kore.modulo+'/series/buscarOwner',
			dataType: "json", 
			type:"POST",
			data: {
				style: "full",
	...
	this.actualizarTitulo=function(){
		...
		if (id>0){						
			$(tabId +' #titulo h1').html('Serie: ' + getValorCampo('serie'));
		}else{
