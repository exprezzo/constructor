var EdicionPuntos_de_venta = function(){
	this.editado=false;
	this.tituloNuevo='Nuevo Punto de Venta';
	...
	this.configurarComboFk_pais=function(){
		...
		$('select[name="fk_pais"]').wijcombobox({			
		 ...
		 $('.contenedor_fk_pais input[role="textbox"]').bind('focus', function(){			
	...
	this.setDSFk_pais = function(){		
		...
		var proxy = new wijhttpproxy({
			url: kore.url_base+kore.modulo+'/puntos_de_venta/buscarPais',
			dataType: "json", 
			type:"POST",
			data: {
				style: "full",
	...
	this.configurarComboFk_estado=function(){
		...
		$('select[name="fk_estado"]').wijcombobox({			
		 ...
		 $('.contenedor_fk_estado input[role="textbox"]').bind('focus', function(){			
	...
	this.setDSFk_estado = function(){		
		...
		var filtering=new Array();
		var proxy = new wijhttpproxy({
			url: kore.url_base+kore.modulo+'/puntos_de_venta/buscarEstado',
			dataType: "json", 
			type:"POST",
			data: {
				style: "full",
	...
	this.configurarComboFk_municipio=function(){
		...
		$('select[name="fk_municipio"]').wijcombobox({			
		 ...
		 $('.contenedor_fk_municipio input[role="textbox"]').bind('focus', function(){			
	...
	this.setDSFk_municipio = function(){		
		...
		var filtering=new Array();
		var proxy = new wijhttpproxy({
			url: kore.url_base+kore.modulo+'/puntos_de_venta/buscarMunicipio',
			dataType: "json", 
			type:"POST",
			data: {
				style: "full",
	...
	this.configurarComboFk_cliente=function(){
		...
		$('select[name="fk_cliente"]').wijcombobox({			
		 ...
		 $('.contenedor_fk_cliente input[role="textbox"]').bind('focus', function(){			
	...
	this.setDSFk_cliente = function(){		
		...
		var filtering=new Array();
		var proxy = new wijhttpproxy({
			url: kore.url_base+kore.modulo+'/puntos_de_venta/buscarCliente',
			dataType: "json", 
			type:"POST",
			data: {
				style: "full",
	...
	this.actualizarTitulo=function(){
		...
		if (id>0){						
			$(tabId +' #titulo h1').html('Punto de Venta: ' + getValorCampo('nombre'));
		}else{
