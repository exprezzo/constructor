var EdicionOwners = function(){
	this.editado=false;
	this.tituloNuevo='Nuevo Dueño';
	...
	this.setDSFk_pais = function(){		
		...
		var proxy = new wijhttpproxy({
			url: kore.url_base+kore.modulo+'/owners/buscarPais',
			dataType: "json", 
			type:"POST",
			data: {
				style: "full",
	...
	this.setDSFk_estado = function(){		
		...
		var filtering=new Array();
		var proxy = new wijhttpproxy({
			url: kore.url_base+kore.modulo+'/owners/buscarEstado',
			dataType: "json", 
			type:"POST",
			data: {
				style: "full",
	...
	this.setDSFk_municipio = function(){		
		...
		var filtering=new Array();
		var proxy = new wijhttpproxy({
			url: kore.url_base+kore.modulo+'/owners/buscarMunicipio',
			dataType: "json", 
			type:"POST",
			data: {
				style: "full",
	...
	this.actualizarTitulo=function(){
		...
		if (id>0){						
			$(tabId +' #titulo h1').html('Dueño: ' + getValorCampo('nombre'));
		}else{
