...
(1060, '', 'auto_increment', 'id', 'PRI', 'NO', 'int(11)', 'Text Input', '{"etiqueta":"Id","requerido":"0","editable":"1","oculto":"0","ayuda":"Id" }', 106),
...
(1, 'AAA010101AAA', 'Razon Social Prueba', 'Nombre Comercial Prueba', '452345', '', 'triples.jpg', 1, 25, 0, 2844, 'conocida', '000', 'Ext 000', 'Fracc. Conocido', 'mazatlan', '', '82180', 'email@email.com');
...
--
-- Estructura de tabla para la tabla `mptt`
--
...
--
-- Volcado de datos para la tabla `mptt`
--

INSERT INTO `mptt` (`id`, `title`, `lft`, `rgt`, `parent`) VALUES
(17, 'Menu Nomina', 1, 18, 0),
(18, 'Nomina', 2, 3, 17),
(19, 'Catalogos', 4, 13, 17),
(20, 'Catalogos SAT', 14, 15, 17),
(21, 'Ayuda', 16, 17, 17),
(22, 'Ubicaciones', 5, 12, 19),
(23, 'Paises', 6, 7, 22),
(24, 'Estados', 8, 9, 22),
(25, 'Municipios', 10, 11, 22);
...
(3, 1, '001', 123, 'Concepto', '0.000000', '0.000000', 2),
...
(5, 0, '', 0, 0, '0.000000', 5),
(6, 0, '', 0, 0, '0.000000', 6),
(8, 12, 'Triples', 2, 123, '123.000000', 2);
...
--
-- Estructura de tabla para la tabla `nomina_menu`
--

CREATE TABLE IF NOT EXISTS `nomina_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
(4, 1, '550', 'Quincena', '550.000000', '0.000000', '001', 2),
