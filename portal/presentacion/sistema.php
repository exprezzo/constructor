...
<div id="global">
    ...
    <div id="encabezado">
        ...
        <div class="contenedorDatos1" style="margin-top: 11px; background-color: transparent;display: inline-block;right: 17px;position: absolute;">         
                    ...
                    <ul class="nav" style="display:inline-block;clear:both;">  
						<li>
							...
							<ul>
								<li><a class="elementoTop" href="<?php echo $_PETICION->url_app.$_PETICION->modulo.'/usuarios/editar/'.$_SESSION['user']['id']; ?>" class="">Editar Mi Perfil<span class="flecha">∨</span></a></li>
		...
		<form name="busqueda" action="<?php echo $_PETICION->url_app.$_PETICION->controlador; ?>/buscar" method="get" id="contenedorBusqueda" style="position:absolute;bottom: 16px;right: 18px;">
