...
var UsuariosDeEmpresa=function (){	
	...
	this.init=function(config){
		...
		var me = this;
		$(this.tabId + "-dialog-confirm-eliminar-usuario").wijdialog({
			autoOpen: false,
            captionButtons: {                  
				pin: { visible: false },
	...
	this.configurarGrid=function(targetSelector, articulos){		
		...
		gridElementos.bind('keydown', function(e) {
			...
			if(e.keyCode==46 && e.shiftKey){
				...
				$(me.tabId + "-dialog-confirm-eliminar-usuario").wijdialog('open');
			}
		});
		...
		gridElementos.wijgrid({
			...
			columns: [
				...
				{ dataKey: "ip_login", visible:true, headerText: "Ip_login" },
				{ dataKey: "last_login", visible:true, headerText: "Last_login" },
				{ dataKey: "fk_rol", visible:true, headerText: "Fk_rol" },
				{ dataKey: "fk_empresa", visible:true, headerText: "Empresa" }
			]
		});
		var me=this;
