var EdicionEmpresas = function(){
	...
	this.guardar=function(){
		...
		//-----------------------------------
		var datos=paramObj;
		$(tabId+' .tabla_usuarios').wijgrid('endEdit');
				var usuarios=$(tabId+' .tabla_usuarios').wijgrid('data');
				datos.usuariosDeEmpresa = usuarios;
		...
		$.ajax({
			...
			if ( resp.success == true	){
				...
				//--------------------
				var elementos=resp.datos.usuariosDeEmpresa;	

				var grid=$(me.tabId+" .tabla_usuarios");
