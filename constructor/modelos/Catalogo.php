...
class CatalogoModelo extends Modelo{	
	...
	var $pk='id';
	var $campos= array('id', 'fk_modulo', 'nombre_Modulo', 'nombre', 'controlador', 'modelo', 'tabla', 'pk_tabla', 'icono', 'titulo_nuevo', 'titulo_edicion', 'titulo_busqueda', 'msg_creado', 'msg_actualizado', 'pregunta_eliminar', 'msg_eliminado', 'msg_cambios', 'campos_busqueda');
 ...
 LEFT JOIN system_modulos AS Modulo0 ON Modulo0.id = Catalogo.fk_modulo';
		...
		if ($paginar){
			$limit=$params['limit'];
			$start=$params['start'];
			$sql = 'SELECT Catalogo.id, Catalogo.fk_modulo, Modulo0.nombre AS nombre_Modulo, Catalogo.nombre, Catalogo.controlador, Catalogo.modelo, Catalogo.tabla, Catalogo.pk_tabla, Catalogo.icono, Catalogo.titulo_nuevo, Catalogo.titulo_edicion, Catalogo.titulo_busqueda, Catalogo.msg_creado, Catalogo.msg_actualizado, Catalogo.pregunta_eliminar, Catalogo.msg_eliminado, Catalogo.msg_cambios, Catalogo.campos_busqueda FROM '.$this->tabla.' Catalogo '.$joins.$filtros.' limit :start,:limit';
		}else{
