		...
		<div id="contenedorDatos2">
			<form class="frmEdicion" style="">
				...
				<div class="inputBox contenedor_clave" style=""  >
					...
					<input title="" type="text" name="clave" class="entradaDatos" value="<?php echo $this->datos['clave']; ?>" style="width:500px;" />
				</div>
				<div class="inputBox contenedor_descripcion" style=""  >
					<label style="">Descripcion:</label>
					<input title="" type="text" name="descripcion" class="entradaDatos" value="<?php echo $this->datos['descripcion']; ?>" style="width:500px;" />
				</div>
				<div class="inputBox contenedor_comentario" style=""  >
					<label style="">Comentario:</label>
					<input title="" type="text" name="comentario" class="entradaDatos" value="<?php echo $this->datos['comentario']; ?>" style="width:500px;" />
				</div>
			</form>
