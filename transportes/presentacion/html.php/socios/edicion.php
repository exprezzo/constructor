	...
	<div id="cuerpo">
		<div id="contenedorDatos2">
			<form class="frmEdicion" style="">
				...
				<div class="inputBox contenedor_domicilio" style=""  >
					<label style="">Domicilio:</label>
					<input type="text" name="domicilio" class="entradaDatos" value="<?php echo $this->datos['domicilio']; ?>" style="width:500px;" />
				</div>
