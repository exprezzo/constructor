var ConceptosDeDocumento=function (){	
	...
	this.init=function(config){
		...
		var me = this;
		$(this.tabId + "-dialog-confirm-eliminar-concepto_documento").wijdialog({
			autoOpen: false,
            captionButtons: {                  
				pin: { visible: false },
	...
	this.configurarGrid=function(targetSelector, articulos){		
		...
		gridElementos.bind('keydown', function(e) {
			...
			if(e.keyCode==46 && e.shiftKey){
				...
				$(me.tabId + "-dialog-confirm-eliminar-concepto_documento").wijdialog('open');
			}
		});
		...
		gridElementos.wijgrid({
			...
			columns: [
				...
				{ dataKey: "um", visible:true, headerText: "Um" },
				{ dataKey: "precio_u", visible:true, headerText: "Precio_u" },
				{ dataKey: "importe", visible:true, headerText: "Importe" },
				{ dataKey: "fk_documento", visible:false, headerText: "Fk_documento" }
			]
		});
		var me=this;
