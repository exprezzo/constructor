var EdicionTipos_de_documento = function(){
	this.editado=false;
	this.tituloNuevo='Nuevo Tipo de Documento';
	this.saveAndClose=false;
	
	
	this.borrar=function(){		
		var r=confirm("¿ Eliminar Tipo de Documento  ?");
		if (r==true){
		  this.eliminar();
		}
	}
	...
	this.actualizarTitulo=function(){
		...
		if (id>0){						
			$(tabId +' #titulo h1').html('Tipo: ' + getValorCampo('nombre'));
		}else{
