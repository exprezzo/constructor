...
class CatalogoModelo extends Modelo{	
	...
	function buscar($params){
		...
		if ($paginar){
			$limit=$params['limit'];
			$start=$params['start'];
			$sql = 'SELECT  FROM '.$this->tabla.' Catalogo '.$joins.$filtros.' limit :start,:limit';
		}else{
			$sql = 'SELECT  FROM '.$this->tabla.' Catalogo '.$joins.$filtros;
		}
 ...
 FROM system_catalogos AS Catalogo
  WHERE Catalogo.{CAMPOLLAVE}=:{CAMPOLLAVE}';
		$pdo = $this->getConexion();
		$sth = $pdo->prepare($sql);
